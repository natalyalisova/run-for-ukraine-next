          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 justify-center">
            <div className="flex justify-start text-start flex-col text-base md:text-lg mt-10">
              <p>
                ...
                справи для ЗСУ. 100% донатів з наших занять будуть спрямовані на
                потреби ЗСУ. Разом з нашим тренером Софією чекаємо вас на
                ковриках, беріть з собою 💛💙 символіку, воду та чудовий
                настрій.
              </p>
            </div>
